                            ...
                            {isSignIn ? (
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-4">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black placeholder-gray-100' style={{background:'none'}} placeholder='Enter nickname' onChange={(e) => setNickname(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black placeholder-gray-100' style={{background:'none'}} placeholder='Enter password' onChange={(e) => setPassword(e.target.value)}/>
                                    </div>

                                    <button type={"submit"} className='text-white text-[18px] px-12 py-3' style={{background: 'linear-gradient(88.76deg, #393939 0.58%, #4D4D4D 98.96%)'}}>ENTER</button>
                                </form>
                            ) : (
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    {/*nick name*/}
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-4">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] placeholder-gray-100' style={{background:'none'}} placeholder='Enter nickname' onChange={(e) => setNickname(e.target.value)}/>
                                    </div>

                                    {/*email*/}
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-4">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 3.5C1.725 3.5 1.5 3.725 1.5 4V4.69063L6.89062 9.11563C7.5375 9.64688 8.46562 9.64688 9.1125 9.11563L14.5 4.69063V4C14.5 3.725 14.275 3.5 14 3.5H2ZM1.5 6.63125V12C1.5 12.275 1.725 12.5 2 12.5H14C14.275 12.5 14.5 12.275 14.5 12V6.63125L10.0625 10.275C8.8625 11.2594 7.13438 11.2594 5.9375 10.275L1.5 6.63125ZM0 4C0 2.89688 0.896875 2 2 2H14C15.1031 2 16 2.89688 16 4V12C16 13.1031 15.1031 14 14 14H2C0.896875 14 0 13.1031 0 12V4Z" fill="white" fillOpacity="0.5"/>
                                        </svg>

                                        <input type="text" className='h-auto w-full border-none text-[18px] placeholder-gray-100' style={{background:'none'}} placeholder='Enter email' onChange={(e) => setEmail(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] placeholder-gray-100' style={{background:'none'}} placeholder='Create password' onChange={(e) => setPassword(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] placeholder-gray-100' style={{background:'none'}} placeholder='Confirm password' onChange={(e) => setConfirmPassword(e.target.value)}/>
                                    </div>
