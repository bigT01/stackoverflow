                            ...
                            {isSignIn ? (
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] placeholder-gray-100' style={{background:'none'}} placeholder='Enter password' onChange={(e) => setPassword(e.target.value)}/>
                                    </div>
