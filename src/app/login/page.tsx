                            ...
                            {!isLoading ? isSignIn ? (
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-4">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black focus-visible:outline-none placeholder-[#FFFFFF50]' style={{background:'none'}} placeholder='Enter nickname' onChange={(e) => setNickname(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black focus-visible:outline-none placeholder-[#FFFFFF50]' style={{background:'none'}} placeholder='Enter password' onChange={(e) => setPassword(e.target.value)}/>
                                    </div>
                                ...
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-4">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black focus-visible:outline-none placeholder-[#FFFFFF50]' style={{background:'none'}} placeholder='Enter email' onChange={(e) => setEmail(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black focus-visible:outline-none placeholder-[#FFFFFF50]' style={{background:'none'}} placeholder='Create password' onChange={(e) => setPassword(e.target.value)}/>
                                    </div>
                                    ...
                                    <div className="flex gap-2 px-4 py-2 w-full bg-gray-400 items-center bg-[#d9d9d933] mb-6">
                                        ...
                                        <input type="text" className='h-auto w-full border-none text-[18px] text-black focus-visible:outline-none placeholder-[#FFFFFF50]' style={{background:'none'}} placeholder='Confirm password' onChange={(e) => setConfirmPassword(e.target.value)}/>
                                    </div>
