        ...
        <div className='text-white'>
            <section className="grid grid-cols-2 gap-10 w-full h-full mx-auto " style={{maxWidth: '95%'}}>
                ...
                <div className='w-full h-full flex flex-col gap-5'>
                    {/*main problem*/}
                    <div className='bg-[#11111170] px-6 py-4 overflow-y-scroll overflow-x-hidden' style={{maxHeight: '50%'}}>
                        <h4 className='text-white font-bold 2xl:text-[30px] lg:text-[24px] mb-3'>Help me to fix this bug. When I run IDE to provide this code it appears that there is an error occured while building project.</h4>
                        <div className='h-[1px] w-full bg-[#353535] mb-3'/>
                        <p className="text-white font-medium 2xl:text-[18px] lg:text-[16px] mb-5">I m using flutter screenshot and I expected the screenshot to not have a banner, but it has. Note that I get a not supported for emulator message for profile and release mode.</p>
                        <div className="flex justify-between items-end">
                            <Image src={`/defaultQuestion.png`} alt={`defaultQuestion-img`} height={315} width={460}/>
                            <div className="flex flex-col gap-5">
                                <div className="py-2 flex-shrink-0 2xl:text-[24px] lg:text-[18px] px-6 bg-[#33333350] w-fit">javascript</div>

                                <div className="flex gap-2 items-center">
                                    <Image src={`/userPhoto.png`} alt={`user-img`} width={41} height={41} style={{width: 45, height: 45}}/>
                                    <div className="flex flex-col gap-1 w-full">
                                        <p className="text-white font-medium 2xl:text-[18px] lg:text-[16px]">Arsen</p>
                                        <p className="text-[#FFFFFF50] font-regular 2xl:text-[16px] lg:text-[14px]">23.04.2023</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full overflow-x-scroll overflow-y-scroll' style={{maxHeight: '25%'}}>
                            <CopyBlock
                                text={`GoogleCredentials googleCredentials() {
                                    if (firebaseProperties.getServiceAccount() != null) {
                                    try (InputStream is = firebaseProperties.getServiceAccount().getInputStream()) {return GoogleCredentials.fromStream(is);
                                }
                                }
                                    else {
...
// Use standard credentials chain. Useful when running inside GKE
                ...
                <div className="flex flex-col gap-5 w-full">
                    {/*header*/}
                    <div className="flex justify-between bg-[#11111170] px-6 py-4 w-ful items-center">
                    ...
                    <div className="px-6 py-4 bg-[#11111170] flex flex-col gap-5 w-full h-full overflow-y-scroll max-h-[60%]">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex items-baseline gap-2">
                                    ...
                                    <p className="text-[#82868D] 2xl:text-[16px] lg: text-[14px]">Today at 09:26</p>
                                </div>
                            </div>
                            {/*text*/}
                            <p className="text-white 2xl:text-[18px] lg:text-[16px]">Reading about people grabbing multi-figures monthly as incomes in investments even in this crazy days in the market, any pointers on how to make substantial progress in earning? would be appreciated.</p>
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    <p className="text-white 2xl:text-[18px] lg:text-[16px]">571</p>
                                </div>
                                {/*dislike*/}
                                <div className="flex gap-2 items-center">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-white 2xl:text-[18px] lg:text-[16px]">3</p>
                                </div>
                                {/*comment*/}
                                <div className="flex gap-2 items-center">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="max-w-full w-auto h-[400px] relative">
                                <Image src={`/defaultQuestion.png`} alt={`defaultQuestion-img`} fill className="object-cover"/>
                            </div>
                            {/*like&dislike&comment*/}
                            <div className="flex gap-4 items-center">
                                {/*like*/}
                                ...
                                <div className="flex gap-2 items-center">
                                    <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.36952 7.13672C5.8578 7.625 6.65077 7.625 7.13905 7.13672L12.1391 2.13672C12.4984 1.77734 12.6039 1.24219 12.4086 0.773437C12.2133 0.304687 11.7601 -3.25748e-08 11.2523 -5.4772e-08L1.25233 -4.91886e-07C0.748425 -5.13912e-07 0.291393 0.304687 0.0960807 0.773437C-0.0992318 1.24219 0.0101432 1.77734 0.365612 2.13672L5.36561 7.13672L5.36952 7.13672Z" fill="white" fillOpacity="0.5"/>
                                    </svg>
